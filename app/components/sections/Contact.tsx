...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative py-16 md:py-24 px-4 sm:px-6 min-h-screen overflow-hidden"
    >
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start">
          {/* LEFT COLUMN CONTENT WRAPPER - Flattens children to grid */}
          <div className="contents">
            {/* HEADER */}
            <div className="text-center md:text-left order-1 md:col-start-1 md:order-1">
              ...
              <p className="text-slate-400 text-base md:text-lg leading-relaxed max-w-md mx-auto md:mx-0">
            ...
            {/* SOCIAL LINKS */}
            <div className="flex gap-4 mt-4 justify-center md:justify-start order-5 md:col-start-1 md:order-4">
              {[
                {
                  icon: <Github size={20} />,
                ...
                },
                {
                  ...
                  href: "https://www.linkedin.com/in/ravi-kumar-keshari-a37828347/",
                  label: "LinkedIn",
                },
                {
                  icon: <Twitter size={20} />,
                  href: "https://x.com/ravi_c029",
                  label: "X",
                },
              ].map((social, i) => (
                <a
          ...
          {/* RIGHT COLUMN CONTENT WRAPPER - Flattens children to grid */}
          <div className="contents">
            {/* FORM */}
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative order-2 md:col-start-2 md:row-start-1 md:row-span-4"
            >
                ...
                {formState === "sent" ? (
                  ...
                  >
                    ...
                    <p className="text-slate-400 text-sm">
                      Your message has been sent to the mainframe.
                    </p>
                    <button
            ...
            <a
              ...
              className="group flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-cyan-500/30 hover:bg-white/10 transition-all order-3 md:col-start-1 md:order-2"
            >
            ...
            {/* MAP CARD */}
            <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5 order-4 md:col-start-1 md:order-3">
